/*-------------------------------------------------------------------------
  Light Control Module for AT05 Optical CT Scanner
  This module controls the pixel LEDs, such as the 8x8 LED array, and 
  interfaces with an 8, 12 and 16 MHz ATmega MCU.
  
  8 MHz MCUs provide output on PORTB and PORTD.
